    ...
    return (
        <footer id="footer">
            ...
            <div className="text">
                ...
                {/*</p>*/}
                <p>
                    This project has been modified based on&nbsp;
                    <CustomLink
                        text={Package.alia}
                        to="https://github.com/imsyy/site-status"
                    />
                    &nbsp;version {Package.version}, rather than using the original version directly. These
                    modifications were made to better suit our operational requirements.
                </p>
                ...
                <p>
                    ...
                    &nbsp;API&nbsp;|&nbsp;Testing frequency 5 minutes
                </p>
                <p>
                    Copyright&nbsp;&copy;&nbsp;2023&nbsp;-&nbsp;{new Date().getFullYear()}
                    &nbsp;
                    <CustomLink to="https://www.acghub.net" text="ACGHub"/>
                    {siteIcp ? (
                        <React.Fragment>
                            &nbsp;|&nbsp;
